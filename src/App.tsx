      ...
      <div className="p-4">
        ...
        <div className="mt-4 flex min-w-0 items-center justify-between gap-2 border-t border-white/10 pt-3">
          <span className="inline-flex min-w-0 items-center gap-1.5 text-[11px] font-bold leading-none text-white/62">
            ...
            <span className="truncate whitespace-nowrap">{formatPromotionDateRange(promotion.startsAt, promotion.endsAt)}</span>
          </span>
      ...
      <div className="p-4 pt-0">
        ...
        {film.priceTableImageUrl ? (
          <div className="mt-5 overflow-hidden rounded-2xl border border-white/10 bg-[#0d0d0d]">
            <div className="border-b border-white/10 px-3 py-2 text-sm font-black text-white">ตารางราคาฟิล์ม</div>
...
function Notice({ message, tone }: { message: string; tone: NoticeTone }) {
  return (
    <div className="pointer-events-none fixed left-0 right-0 top-[4.75rem] z-[120] flex justify-center px-4 md:left-72 md:px-6 lg:px-8">
      <div
        className={[
